        ...
        <>
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <div className="container-fluid">
                    <NavLink className="navbar-brand" aria-current="page" exact="true" to="/privado">G+SMH</NavLink>
                            ...
                            {usuario &&
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li><NavLink className="dropdown-item" exact="true" to="clinicas">Clinicas</NavLink></li>
                                        <li><NavLink className="dropdown-item" exact="true" to="medicos">Medicos</NavLink></li>
                                    </ul>
                                </li>
                            }
                            <li className="nav-item dropdown">
